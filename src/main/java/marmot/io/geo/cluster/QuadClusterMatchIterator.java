 ...
 */
class QuadClusterMatchIterator<T extends QuadCluster> implements Iterator<Match<String>> {
	...
	QuadClusterMatchIterator(QuadClusterFile<? extends T> left, QuadClusterFile<? extends T> right) {
